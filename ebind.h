...
struct key_tab keytab[NBINDS] = {
	...
	{ SPEC | 'C', forwchar },
	{ SPEC | 'D', backchar },
	{ META | SPEC | 'A', backline },
	{ META | SPEC | 'B', forwline },
	{ META | SPEC | 'C', forwchar },
	{ META | SPEC | 'D', backchar },
	{ META | SPEC | '5', backpage },
	{ META | SPEC | '6', forwpage },
	{ CONTROL | META | SPEC | 'A', backline },
	{ CONTROL | META | SPEC | 'B', forwline },
	{ CONTROL | META | SPEC | 'C', forwchar },
	{ CONTROL | META | SPEC | 'D', backchar },
	{ CONTROL | META | SPEC | '5', backpage },
	{ CONTROL | META | SPEC | '6', forwpage },
	{ SPEC | 'c', metafn },
	{ SPEC | 'd', backchar },
	{ SPEC | 'e', forwline },
	{ SPEC | 'f', gotobob },
